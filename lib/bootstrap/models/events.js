...
var eventTimeSlot = require('./../relations/event-timeSlot');
...
var events = [
  ...
  {
    name: 'Barcamp Candidate 1',
    type: 'PLACEHOLDER'
  },
  {
    name: 'Barcamp Candidate 2',
    type: 'PLACEHOLDER'
  },
  {
    name: 'Barcamp Candidate 3',
    type: 'PLACEHOLDER'
  },
  {
    name: 'Barcamp Candidate 4',
    type: 'PLACEHOLDER'
  },
  {
...
events.forEach(function(event) {
  var timeSlotName = eventTimeSlot[event.name];
  var timeSlot = findTimeSlotByName(timeSlotName);
  event.startDate = timeSlot.startDate;
  event.endDate = timeSlot.endDate ? timeSlot.endDate : null;
});
